...
class Codechef
{
	public static void main (String[] args) throws java.lang.Exception
	{
		...
		while(r < n){
		    ...
		    // we used if condition instead of while because we don't need to take a window less than the maxlen.
		    //whenever we want just the maxLen or any one value we use this
		    if(sum > k){
