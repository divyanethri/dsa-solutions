...
class Codechef
{
	...
	{
		//Longest Substring with at most k Distinct Characters Optimised Approach
		...
		while(r < s.length()){
		    ...
		    //increment the left
		    //here instead of while loop and remove the elements we just check everytime and remove the element
		    if(map.size() > k){
